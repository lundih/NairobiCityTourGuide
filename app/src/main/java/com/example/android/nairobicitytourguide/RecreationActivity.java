...
public class RecreationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionbar.setTitle(R.string.title_action_bar_recreation);
        if (actionbar!= null){
        ...
        CustomFragmentPagerAdapter adapter = new CustomFragmentPagerAdapter(RecreationActivity.this, getSupportFragmentManager(), RECREATION);
